		...
		<div className="flex flex-col space-y-8 p-8">
			<div className="prose dark:prose-invert">
				...
				<p>
					...
					might want the content to fill its container&rsquo;s full width. In these cases, you just need to add `max-w-none` to your content to override the built-in max-width. Summary: The
